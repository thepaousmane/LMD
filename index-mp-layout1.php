  ...
  <header id="header" class="header">
        ...
        <div class="container">
          <nav id="menuzord-right" class="menuzord default">
            <a class="menuzord-brand pull-left flip" href="javascript:void(0)">
              ...
              <img alt="UPA" width="250" height="200" src="images/index.jpg">
                          <!-- <img class="mt-10 mb-15" alt="UPA" height="100" width="100" src="images/index.jpg"> -->
            ...
            <ul class="menuzord-menu">
              ...
              <li><a href="#home">Départements</a>
                <ul class="dropdown">
                  <li><a href="page-course-gird.html">Sante</a></li>
                  <li><a href="page-course-list.html">Génie Informatique </a></li>
                  <li><a href="page-courses-accounting-technologies.html">Génie Civil</a></li>
                  <li><a href="page-courses-chemical-engineering.html">Génie Mécanique</a></li>
                  <li><a href="page-courses-computer-technologies.html">Gestion</a></li>
   ...
   <li class="active"><a href="#home">Se connecter</a>
               ...
               <ul class="dropdown">
                  ...
                  <li><a href="index.php?dir=valeur1">Directeur</a>
                  </li>  
                  <li><a href="index.php?prof=valeur2">Professeur</a>
                  </li>
                  <!-- <li><a href="index.php?etu=valeur3">Etudiant</a> -->
                  </li>
                  <li><a href="index.php?etu=valeur1">Responsable Classe</a>
                  </li> 
                  <!-- <li><a href="seconnecterQQQ\colorlib-regform-8\index.php?dir=valeur1">DirecteurOG</a> -->
                  </li>  
              </ul>
     </li>
          ...
          <div class="col-md-12">
            <div class="owl-carousel-4col">
              <div class="item">
                <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" height="310" src="images/im1.png">
              ...
              <div class="item">
                <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" height="310" src="images/im2.png">
                    <div class="team-overlay"></div>
                  </div>
                  <div class="team-details bg-silver-light pt-10 pb-10">
                    <h4 class="text-uppercase font-weight-600 m-5"><a href="page-teachers-details.html">Jhon Smith</a></h4>
              ...
              <div class="item">
                <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" height="310" src="images/im3.png">
                    <div class="team-overlay"></div>
                  </div>
                  <div class="team-details bg-silver-light pt-10 pb-10">
                    <h4 class="text-uppercase font-weight-600 m-5"><a href="page-teachers-details.html">Jhon Smith</a></h4>
              ...
              <div class="item">
                <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" src="images/im4.png">
                    <div class="team-overlay"></div>
                  </div>
                  <div class="team-details bg-silver-light pt-10 pb-10">
                    <h4 class="text-uppercase font-weight-600 m-5"><a href="page-teachers-details.html">Jhon Smith</a></h4>
