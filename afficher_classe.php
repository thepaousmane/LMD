...
for($i=1;$i<=$_SESSION['df_sp'];$i++)
{
  if(!empty($_POST['annee'.$i]))
  {
    $_SESSION['nom_classe']=$_POST['annee'.$i]; 
    $_SESSION['number_classe']=$i;
  }
}
$nom_specialite=$_SESSION['nom_specialite'];
$name_section=$_SESSION['name_section'];
echo"spécialité : ".$_SESSION['nom_specialite'];
echo"<br>";
echo"section : ".$_SESSION['name_section'];
echo"<br>";
...
for($i=1;$i<=$_SESSION['df_sp'];$i++)
{
  if(!empty($_POST['annee'.$i]))
  {
    $_SESSION['nom_classe']=$_POST['annee'.$i];       //si on fait echo $_SESSION['nom_classe'] ça va afficher : genre ==> annee_1
    for($j=1;$j<=2;$j++)
    {
      $toto=0;
      $classe_number=$i;
...
//<!---------------------------------- Affichage du tableau de semestre sinon de "Creer la semestre_" -------------------------------------->
