...
?>
      <form>
        <legend>L1 Sage Femme </legend>
         droit du travail <progress name="ido" value="8" max="15"></progress>8 "Heures"      
      </form>
      <form>
        <legend>L3 Infirmier </legend>
         Microobiologie <progress name="ido" value="6" max="15"></progress>6 "Heures"                  
      </form>     
       <form>
        <legend>L2 Assistant Infirmier </legend>
         redaction administrative <progress name="ido" value="2" max="15"></progress>2 "Heures"                 
      </form>
      <form>
        <legend>L2 Assistant Infirmier </legend>
         sociologie <progress name="ido" value="4" max="15"></progress>4 "Heures"
      </form>
    </fieldset>
