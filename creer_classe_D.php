...
<?php 
  echo "Nom de la specialite : ".$_SESSION['nom_specialite_D'];
  echo"<br>";
  echo "Nom de la section : ".$_SESSION['name_departement'];
  echo"<br>";
  // for($cpt=1;$cpt<=$_SESSION['df_sp'];$cpt++)
  // {
  //   if((!empty($_SESSION['nom_classe']))&&(empty($_POST['annee'.$cpt])))
  //   {
  ...
  // echo"<br>";
      ...
      // ||(!empty($_SESSION['nom_classe']))
for($cpt=1;$cpt<=$_SESSION['df_sp_D'];$cpt++)
{
  if((!empty($_POST['annee'.$cpt])))
  { 
    $_SESSION['number_classe_D']=$cpt;
    $_SESSION['nom_classe_D']=$_POST['annee'.$cpt];
...
for($o=1;$o<=2;$o++)
{
    ...
    if(!empty($_POST['semestre'.$o]))
    {
      ...
      $_SESSION['semestre_D']=$_POST['semestre'.$o];
      $_SESSION['semestre_D']='semestre '.$o;
      $_SESSION['number_semestre_D']=$o;
    ...
    if(!empty($_POST['nbr_ue'.$e]))
      {
        ...
        $_SESSION['nbr_ue_D']=$_POST['nbr_ue'.$e];
...
//Pour empêcher les anciennes variables de sessions se chargaient 
  ...
  {
    if(isset($_SESSION['name_ue_D'.$i]))
    {
      unset($_SESSION['name_ue_D'.$i]);
    }

    if(isset($_SESSION['total_cdt_ue__D'.$i]))
    {
      unset($_SESSION['total_cdt_ue__D'.$i]);
    }

    if(!empty($_SESSION['nbr_matiere_D'.$i]))
    {
      for($p=1;$p<=$_SESSION['nbr_matiere_D'.$i];$p++)
      {
        if(isset($_SESSION['name_matiere__D'.$p.'_'.$i]))
        {
            unset($_SESSION['name_matiere__D'.$p.'_'.$i]);
        }
        if(isset($_SESSION['Nb_Heures_CM__D'.$p.'_'.$i]))
        {
          unset($_SESSION['Nb_Heures_CM__D'.$p.'_'.$i]);
        }

        if(isset($_SESSION['Nb_Heures_TD__D'.$p.'_'.$i]))
        {
          unset($_SESSION['Nb_Heures_TD__D'.$p.'_'.$i]);
        }

        if(isset($_SESSION['Nb_Heures_TP__D'.$p.'_'.$i]))
        {
          unset($_SESSION['Nb_Heures_TP__D'.$p.'_'.$i]);
        }

        if(isset($_SESSION['Nb_Heures_TPE__D'.$p.'_'.$i]))
        {
          unset($_SESSION['Nb_Heures_TPE__D'.$p.'_'.$i]);
        }
        
        if(isset($_SESSION['Nb_Heures_total__D'.$p.'_'.$i]))
        {
          unset($_SESSION['Nb_Heures_total__D'.$p.'_'.$i]);
        }
       
        if(isset($_SESSION['Coef__D'.$p.'_'.$i]))
        {
          unset($_SESSION['Coef__D'.$p.'_'.$i]);
        }
        
        if(isset($_SESSION['Credit_UE_D'.$p.'_'.$i]))
        {
          unset($_SESSION['Credit_UE_D'.$p.'_'.$i]);
        }
  ...
  for($i=1;$i<=$_SESSION['nbr_ue_D'];$i++)
  {
    if(!empty($_SESSION['nbr_matiere_D'.$i]))
    {
      unset($_SESSION['nbr_matiere_D'.$i]);
    }
  }
}
  ?>
...
<?php
  if(!empty($_POST['modifier_semestre'])||(!empty($_POST['name_nbr_semestre'])))
  {
    echo 'Classe : '.$_SESSION['nom_classe_D'];
    echo"<br>";
    ...
    // UE_semestre_".$semestre_number."_".$nom_specialite."_".$name_section."

    // $sql= "create TABLE semestre_".DROP TABLE IF EXISTS semestre_.")
// 
  }
...
<?php
    ...
    for($i=1;$i<=$_SESSION['nbr_ue_D'];$i++)
    {
        if(!empty($_POST['name_ue_'.$i])||(!empty($_SESSION['name_ue_D'.$i])))
        {
          if(!empty($_POST['name_ue_'.$i]))
          {
            $_SESSION['name_ue_D'.$i]=$_POST['name_ue_'.$i];
          }
      ?>
<!------------------------------------ Pour Unité d'enseignment ---------------------------->
    ...
    <tr class="bleuX">
        ...
        <td>
          ...
          value="<?php if(isset($_SESSION['total_cdt_ue__D'.$i]))
          {echo $_SESSION['total_cdt_ue__D'.$i]; } ?>" size="15"/>
          <!-- type="number" size="15" /> -->
        </td>
    </tr>
  ...
  <?php
        if(!empty($_POST['nbr_matiere_'.$i])||(!empty($_SESSION['name_ue_D'.$i])))
        { 
          if(!empty($_POST['nbr_matiere_'.$i]))
          {
            $_SESSION['nbr_matiere_D'.$i]=$_POST['nbr_matiere_'.$i];
          }
      ...
      <tr>
        ...
        <td>
          ...
          value="<?php if(isset($_SESSION['name_matiere__D'.$p.'_'.$i]))
          {echo $_SESSION['name_matiere__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>

        <td>
          <input required type="number" name="Nb_Heures_CM_<?php echo $p."_".$i;?>" 
          value="<?php if(isset($_SESSION['Nb_Heures_CM__D'.$p.'_'.$i]))
          {echo $_SESSION['Nb_Heures_CM__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>

        <td>
          <input required type="number" name="Nb_Heures_TD_<?php echo $p."_".$i;?>"
          value="<?php if(isset($_SESSION['Nb_Heures_TD__D'.$p.'_'.$i]))
          {echo $_SESSION['Nb_Heures_TD__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>

        <td>
          <input required type="number" name="Nb_Heures_TP_<?php echo $p."_".$i;?>" 
          value="<?php if(isset($_SESSION['Nb_Heures_TP__D'.$p.'_'.$i]))
          {echo $_SESSION['Nb_Heures_TP__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>

        <td>
          <input required type="number" name="Nb_Heures_TPE_<?php echo $p."_".$i;?>" 
          value="<?php if(isset($_SESSION['Nb_Heures_TPE__D'.$p.'_'.$i]))
          {echo $_SESSION['Nb_Heures_TPE__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>

        <td>
          <input required type="number" name="Nb_Heures_total_<?php echo $p."_".$i;?>" 
          value="<?php if(isset($_SESSION['Nb_Heures_total__D'.$p.'_'.$i]))
          {echo $_SESSION['Nb_Heures_total__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>
        
        <td>
          <input required type="number" name="Coef_<?php echo $p."_".$i;?>" 
          value="<?php if(isset($_SESSION['Coef__D'.$p.'_'.$i]))
          {echo $_SESSION['Coef__D'.$p.'_'.$i]; } ?>" size="22"/>
        </td>
        
        <td>
          <input required type="number" disabled type="number" name="Credit_UE<?php echo $p."_".$i;?>">
        </td> 
...
if(!empty($_POST['submit_table']))
{
  ...
  {  
    ...
    // {
          ...
          echo"<br>";
        $_SESSION['som_CM_D'.$i]=0;
        $_SESSION['som_TD_D'.$i]=0;
        $_SESSION['som_TP_D'.$i]=0;
        $_SESSION['som_TPE_D'.$i]=0;
        $_SESSION['som_Total_D'.$i]=0;
        // $_SESSION['som_coef'.$i]=0;
        $_SESSION['som_credit_ue_D']=0;
    //   }
    // }
  }
...
//   {  
              ...
              echo"<br>";
        $_SESSION['som_sm_CM_D']=0;
        $_SESSION['som_sm_TD_D']=0;
        $_SESSION['som_sm_TP_D']=0;
        $_SESSION['som_sm_TPE_D']=0;
        $_SESSION['som_sm_Total_D']=0;
        // $_SESSION['som_coef'.$i]=0;
        $_SESSION['som_sm_credit_ue_D']=0;
//   }
// ---------------------------fin-----------------------
...
// &&(isset($_POST['Nb_Heures_total_'.$y.'_'.$i])))
  ...
  for($i=1;$i<=$_SESSION['nbr_ue_D'];$i++)
  {
    if((!empty($_SESSION['nbr_matiere_D'.$i]))&&(!empty($_SESSION['name_ue_D'.$i])))
    {
      $nbr_matiere=$_SESSION['nbr_matiere_D'.$i];
...
&&(isset($_POST['Nb_Heures_total_'.$y.'_'.$i])))
      {
          ...
          $_SESSION['Nb_Heures_CM__D'.$y.'_'.$i]=$_POST['Nb_Heures_CM_'.$y.'_'.$i];
          $_SESSION['Nb_Heures_TD__D'.$y.'_'.$i]=$_POST['Nb_Heures_TD_'.$y.'_'.$i];
          $_SESSION['Nb_Heures_TP__D'.$y.'_'.$i]=$_POST['Nb_Heures_TP_'.$y.'_'.$i];
          $_SESSION['Nb_Heures_TPE__D'.$y.'_'.$i]=$_POST['Nb_Heures_TPE_'.$y.'_'.$i];
          $_SESSION['Nb_Heures_total__D'.$y.'_'.$i]=$_POST['Nb_Heures_total_'.$y.'_'.$i];
          $_SESSION['Coef__D'.$y.'_'.$i]=$_POST['Coef_'.$y.'_'.$i];
          $_SESSION['name_matiere__D'.$y.'_'.$i]=$_POST['name_matiere_'.$y.'_'.$i];
          ...
          $_SESSION['som_CM_D'.$i]=$_SESSION['som_CM_D'.$i]+$_POST['Nb_Heures_CM_'.$y.'_'.$i];
          $_SESSION['som_TD_D'.$i]=$_SESSION['som_TD_D'.$i]+$_POST['Nb_Heures_TD_'.$y.'_'.$i];
          $_SESSION['som_TP_D'.$i]=$_SESSION['som_TP_D'.$i]+$_POST['Nb_Heures_TP_'.$y.'_'.$i];
          $_SESSION['som_TPE_D'.$i]=$_SESSION['som_TPE_D'.$i]+$_POST['Nb_Heures_TPE_'.$y.'_'.$i];
          $_SESSION['som_Total_D'.$i]=$_SESSION['som_Total_D'.$i]+$_POST['Nb_Heures_total_'.$y.'_'.$i];
    ...
    // if((!empty($_SESSION['name_ue'.$i]))&&((!empty($_POST['total_cdt_ue_'.$i]))||(($_POST['total_cdt_ue_'.$i])==0)) )
    if((!empty($_SESSION['name_ue_D'.$i]))&&(isset($_POST['total_cdt_ue_'.$i])) )
    {
        $_SESSION['total_cdt_ue__D'.$i]=$_POST['total_cdt_ue_'.$i];
        $_SESSION['som_credit_ue_D']=$_SESSION['som_credit_ue_D']+$_POST['total_cdt_ue_'.$i];
  ...
  for($i=1;$i<=$_SESSION['nbr_ue_D'];$i++)
  {
    if(!empty($_SESSION['name_ue_D'.$i]))
    {
      ...
      // {
        echo "Pour UE : ".$_SESSION['name_ue_D'.$i]." : ";
        echo"<br>";

        echo "total CM : ".$_SESSION['som_CM_D'.$i];
        echo"<br>";

        echo " total TD : ".$_SESSION['som_TD_D'.$i];
        echo"<br>";

        echo " total TP : ".$_SESSION['som_TP_D'.$i];
        echo"<br>";
        

        echo "total TPE : ".$_SESSION['som_TPE_D'.$i];
        echo"<br>";
        
        echo "Nombre heure total : ".$_SESSION['som_Total_D'.$i];
        echo"<br>";
        
        echo"<br>";

      $_SESSION['som_sm_CM_D']=$_SESSION['som_sm_CM_D']+$_SESSION['som_CM_D'.$i];
      $_SESSION['som_sm_TD_D']=$_SESSION['som_sm_TD_D']+$_SESSION['som_TD_D'.$i];
      $_SESSION['som_sm_TP_D']=$_SESSION['som_sm_TP_D']+$_SESSION['som_TP_D'.$i];
      $_SESSION['som_sm_TPE_D']=$_SESSION['som_sm_TPE_D']+$_SESSION['som_TPE_D'.$i];
      $_SESSION['som_sm_Total_D']=$_SESSION['som_sm_Total_D']+$_SESSION['som_Total_D'.$i];
      // $_SESSION['som_coef'.$i]=0;
...
// echo $_SESSION['name_ue'.$i];
  echo "Dollar post som_credit_ue total est de : ".$_SESSION['som_credit_ue_D'];

  $_SESSION['som_sm_credit_ue_D']=$_SESSION['som_credit_ue_D'];
...
?>
<form action="afficher_classe_D.php" method="post">
    <table border="1">
      <tr>
          <th>Matieres</th>
          <th>Nb Heures CM</th>
    ...
    <!-------------------------------- Pour Semestre X -------------------------------------->
      ...
      <tr class="marron">
         ...
         <td>
            <?php 
                echo $_SESSION['som_sm_CM_D'];
            ?>
          <!-- <input disabled placeholder="total heure CM Semestre" type="number" size="15"/> -->
        </td>
        <td>
            <?php 
                echo $_SESSION['som_sm_TD_D'];
            ?> 
          <!-- <input disabled placeholder="total heure TD Semestre" type="number" size="15"/> -->
        </td>
        <td>
            <?php 
                echo $_SESSION['som_sm_TP_D'];
            ?> 
        ...
        <td>
            <?php 
                echo $_SESSION['som_sm_TPE_D'];
            ?>         
          <!-- <input disabled placeholder="total heure TPE Semestre" type="number" size="15"/> -->
        </td>
        <td>
            <?php 
                echo $_SESSION['som_sm_Total_D'];
            ?> 
          <!-- <input disabled placeholder="Nombre heure total Semestre" type="number" size="15"/> -->
        </td>
        <td>
        ...
        <td>
            <?php 
                echo $_SESSION['som_sm_credit_ue_D'];
            ?> 
          <!-- <input disabled placeholder="Total crédit_UE Semestre" type="number" size="15" /> -->
        </td>
    </tr>
...
<?php
    ...
    <tr class="bleuX">
         <td>
            <?php echo'UE : '.$_SESSION['name_ue_D'.$i]; ?>
        
         </td>
         <td>
            <?php 
    echo $_SESSION['som_CM_D'.$i]; ?>
          </td>
          <td>
              <?php 
    echo $_SESSION['som_TD_D'.$i]; ?>
          </td>  
          <td>
              <?php
    echo $_SESSION['som_TP_D'.$i]; ?>
          </td>
          <td>
              <?php 
    echo $_SESSION['som_TPE_D'.$i]; ?>
          </td>
          <td>
              <?php
    echo $_SESSION['som_Total_D'.$i]; ?>
          </td>
          <td>
              <input disabled type="number" size="15"/>
          </td>
  ...
  <?php
        ...
        //   $_SESSION['nbr_matiere'.$i]=$_POST['nbr_matiere_'.$i];
          ...
          for($o=1;$o<=$_SESSION['nbr_matiere_D'.$i];$o++)
          {
      ?>
...
<?php 
if(!empty($_POST['valider_semestreXXX']))
  {
    ...
    // echo"dollar number classe : ".$_SESSION['number_classe'];
    echo"<br>";
  ...
  $sql= "create TABLE IF NOT EXISTS semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."(
...
$sql3="create TABLE IF NOT EXISTS ue_semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."(
  id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  Unite_Enseignement varchar(100) NULL,
  semestre int(100) default 0,
  ...
  $conn3->exec($sql3);
   ...
   $sql4=$conn4->prepare("SELECT * from ue_semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."
      ");
   $sql4->execute();
   $data4=$sql4->fetchAll();
   $nbr = $sql4->rowCount();
    if($nbr<=0)//----------------------JE PENSE QU'IL FAUT SUPPRIMER CE IF----------------------------------
    {
      for($i=1;$i<=$_SESSION['nbr_ue'];$i++)
      {
        if(!empty($_SESSION['name_ue'.$i]))
        {
          // for($o=1;$o<=$_SESSION['name_ue'.$i];$o++)
          // {
            $name_ue=$_SESSION['name_ue'.$i];
            $som_CM=$_SESSION['som_CM'.$i];
            $som_TD=$_SESSION['som_TD'.$i];
            $som_TP=$_SESSION['som_TP'.$i];
            $som_TPE=$_SESSION['som_TPE'.$i];
            $som_Total=$_SESSION['som_Total'.$i];
            $cdt_ue=$_SESSION['total_cdt_ue_'.$i];

            $conn=new PDO("mysql:host=127.0.0.1;dbname=upa","root");
            $sql = "INSERT INTO UE_semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section." 
            (Unite_Enseignement, semestre, specialite, section, annee, Nb_Heures_CM, Nb_Heures_TD, Nb_Heures_TP, 
            Nb_Heures_TPE, Nb_Heures_Total, credit_ue) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            $stmt= $conn->prepare($sql);
            $stmt->execute([$name_ue, $semestre_number, $nom_specialite, $name_section, $classe_number, $som_CM, 
   ...
   $conn2=new PDO("mysql:host=127.0.0.1;dbname=upa;charset=utf8","root");
    $sql=$conn2->prepare("SELECT * from semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."
      ");
    $sql->execute();
    $data2=$sql->fetchAll();
    // echo count($data2);
    ...
    if($nbr<=0)//----------------------JE PENSE QU'IL FAUT SUPPRIMER CE IF----------------------------------
    {
      ...
      if(!empty($_SESSION['nbr_matiere'.$i]))
        { 
          ...
          {
            $name_matiere=$_SESSION['name_matiere_'.$y.'_'.$i];
            $Nb_Heures_CM=$_SESSION['Nb_Heures_CM_'.$y.'_'.$i];
            $Nb_Heures_TD=$_SESSION['Nb_Heures_TD_'.$y.'_'.$i];
            $Nb_Heures_TP=$_SESSION['Nb_Heures_TP_'.$y.'_'.$i];
            $Nb_Heures_TPE=$_SESSION['Nb_Heures_TPE_'.$y.'_'.$i];
            $Nb_Heures_total=$_SESSION['Nb_Heures_total_'.$y.'_'.$i];
            $Coef=$_SESSION['Coef_'.$y.'_'.$i];

            $conn=new PDO("mysql:host=127.0.0.1;dbname=upa","root");
            $sql = "INSERT INTO semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section." 
            (Unite_Enseignement, matiere, Nb_Heures_CM, Nb_Heures_TD, Nb_Heures_TP, 
            Nb_Heures_TPE, Nb_Heures_Total, coef) VALUES (?,?,?,?,?,?,?,?)";
            $stmt= $conn->prepare($sql);
            $stmt->execute([$name_ue, $name_matiere, $Nb_Heures_CM, 
  ...
  ?>
<form action="afficher_classe_D.php" method="get">
    <table border="1">
      <tr>
          <th>Matieres</th>
          <th>Nb Heures CM</th>
   ...
   <?php
        $conn3=new PDO("mysql:host=127.0.0.1;dbname=upa;charset=utf8","root");
        $sql3=$conn3->prepare("SELECT * from ue_semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."
          ");
        $sql3->execute();
    ...
    <?php
        $Unite_Enseignement=$data3['Unite_Enseignement'];
        $conn5=new PDO("mysql:host=127.0.0.1;dbname=upa;charset=utf8","root");
        $sql5=$conn5->prepare("SELECT * from semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."
         WHERE Unite_Enseignement='".$Unite_Enseignement."' ");
          // id='".$idX."'
        $sql5->execute();
...
<?php
   ...
   ?>
    ...
    <input type="submit" name="double_validation_semestre" value="valider le semestre"/>
</form>

 <?php
//  header("Location: afficher_classe.php", true, 303);
//  header( "Refresh:5; url=http://localhost/UPA/afficher_classe.php", true, 5);
// header('Location: http://UPA/afficher_classe.php');
// exit();
  echo '<meta http-equiv="refresh" content="5;URL=\'http://localhost/UPA/afficher_classe.php\'">';
