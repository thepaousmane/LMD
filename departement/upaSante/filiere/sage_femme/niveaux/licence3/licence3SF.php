...
<head>
	<meta charset="utf-8">
	<title>licence 3 Sage femme</title>
...
<!-- echo '<html>'; UTILISATION SYMPHONY-->
  <header id="header" class="header">
   ...
   <li class="active"><a href="#home">Se connecter</a>
	...
	<?php 
		$classe="licence 3 sage femme";
		echo $classe;
	?>
	<p>licence 3 Sage Femme</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence3SF.php">	
...
<?php
	...
	<?php  
		if(isset($_GET['licence3SF']))
		{ 
			?>
				<!-- SEMESTRE 1 SAGE FEMME -->
				<h1>SEMESTRE 1</h1>
				<table border="1">
					<thead>
					<tr>
