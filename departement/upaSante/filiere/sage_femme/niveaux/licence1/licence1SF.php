...
<head>
	...
	<script type="text/javascript">
		...
		window.location.assign("http://localhost/UPA/departement/upaSante/filiere/sage_femme/sage_femme.php");
		});
...
<body>
	<!---------------------HEADER-------------------licence3GI----------------------HEADER-----------------------------------------------------HEADER------------------------------------->
...
<?php
	...
	<?php  
		...
		{ 
			?>
				...
				<table border="1">
					...
					<tr>
						...
						<td>
							Hygiène Assainissement<br>
              pathologie chirugicale<br>
              diagnostics infirmier en rapport avec les pathologies étudiées<br>
						</td>
					</tr>
          ...
          <tr>
            <td>
              Appliquer les méthodes et techniques des soins infirmiers et des soins obstréticaux
            </td>
            <td>
              Hygiène Assainissement<br>
              pathologie chirugicale<br>
          ...
          <tr>
            <td>
              Appliquer les méthodes et techniques des soinns infirmiers et des
            </td>
            <td>
              Hygiène Assainissement<br>
              pathologie chirugicale<br>
