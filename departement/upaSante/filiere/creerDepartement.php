...
<!--//////////////////////--Si Département existe--////////////////////////////////////////////////////////////////-->
<?php if(!empty($_POST['departement'])) { ?>
<form action="creerDepartement.php" method="post">
  <label>Entrer le nom du Département</label>
  <input type="text" name="nom_Departement" required/><br><br>
  <label>entrer le nombre de spécialité</label>
  <input type="number" name="nbr_specialite_D" required/><br><br>

  <button type="submit" name="suivant_D" value="suivant">Suivant</button>
</form>
<?php } ?>
<?php
if(!empty($_POST['suivant_D']))
  {
    ?>
  <form action="../../../directeur.php" method="post">

<?php
  $_SESSION['nom_Departement']=$_POST['nom_Departement'];
  $_SESSION['nbr_specialite_D']=$_POST['nbr_specialite_D'];?>
  
      <?php for($i=1;$i<=$_SESSION['nbr_specialite_D'];$i++)
        { ?>
    <fieldset>Spécialité <?php echo $i?>
        <label>Entrer le nom de la spécialité</label>
        <input type="text" name="specialite_D_<?php echo"$i";?>" required/>
        <label>Entrer la durée de la formation</label>
        <input type="number" name="duree_formation_D_<?php echo"$i";?>" required/>
    </fieldset>
  <?php } ?>  
        <!-- <button type="submit">Valider</button> -->
        <input type="submit" name="valider_departement" value="Valider">
  </form>
...
<form action="creerDepartement.php" method="post">
  <label>entrer le nom de la section</label>
  <input type="text" name="nom_section" required/><br><br>
  <label>entrer le nombre de spécialité</label>
  <input type="number" name="nbr_specialite" required/><br><br>

  <button type="submit" name="suivant" value="suivant">Suivant</button>
</form>
<?php } ?>
<?php
// if(!empty($_POST['nbr_spécialite'])&&(!empty($_POST['nom_section']))){
//   echo"existe";
// }
  ...
  <form action="../../../directeur.php" method="post">
<?php
  $_SESSION['nom_section']=$_POST['nom_section'];
  $_SESSION['nbr_specialite']=$_POST['nbr_specialite'];?>
  
      <?php for($i=1;$i<=$_SESSION['nbr_specialite'];$i++)
        { ?>
    <fieldset>Spécialité <?php echo $i?>
        <label>Entrer le nom de la spécialité</label>
        <input type="text" name="specialite_<?php echo"$i";?>" required/>
        <label>Entrer la durée de la formation</label>
        <input type="number" name="duree_formation_<?php echo"$i";?>" required/>
    </fieldset>
  <?php } ?>  
        <!-- <button type="submit">Valider</button> -->
        <input type="submit" name="valider_section" value="Valider">
  </form>
...
// echo"nom section : ".$_SESSION['nom_section'];
// echo"nbre de specialité de la section : ".$_SESSION['nbr_specialite'];
...
//   $conn=new PDO("mysql:host=127.0.0.1;dbname=upa","root");
//   $sql = "INSERT INTO specialite_section (nom_specialite, duree_formation_specialite) VALUES (?,?)";
//   $stmt= $conn->prepare($sql);
//   $stmt->execute([$nom_speciality, $duree_formation_speciality]);
// }
