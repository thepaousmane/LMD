...
<head>
	<meta charset="utf-8">
	<title>licence 2 génie Civil</title>
...
<body>
	<!---------------------HEADER-------------------licence3GC----------------------HEADER-----------------------------------------------------HEADER------------------------------------->
<!-- echo '<html>'; UTILISATION SYMPHONY-->
  <header id="header" class="header">
   ...
   <li class="active"><a href="#home">Se connecter</a>
	...
	<?php 
		$classe="licence 3 génie Civil";
		echo $classe;
	?>
	<p>licence 3 génie Civil</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence3GC.php">	
