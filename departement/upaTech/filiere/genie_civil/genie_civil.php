...
<head>
	...
	<title>Génie civil</title>
		...
		window.location.assign("http://localhost/UPA/departement/upaTech/indexFiliereTechnique.php");
		});
		// C:\wamp64\www\UPA\departement\upaTech
</script> 
...
<body>
   ...
   <li class="active"><a href="#home">Se connecter</a>
  	...
  	<!----------------FIN-----HEADER----------------FIN-----HEADER----------------FIN-----HEADER----------------FIN-----HEADER----------------FIN-----HEADER------->
