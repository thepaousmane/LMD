...
<head>
	<meta charset="utf-8">
  <title>licence 3 génie Informatique</title>
  <script type="text/javascript">
    history.pushState(null, null, "<?php //echo $_SERVER["REQUEST_URI"]; ?>");
    window.addEventListener("popstate", function(event) {
    window.location.assign("http://localhost/UPA/departement/upaTech/filiere/genie_informatique/informatique.php");
    });
    // C:\wamp64\www\UPA\departement\upaSante\filiere\sage_femme
  </script>

<!--   <script type="text/javascript">
    history.pushState(null, null, "<?php //echo $_SERVER["REQUEST_URI"]; ?>");
    window.addEventListener("popstate", function(event) {
    window.location.assign("http://localhost/UPA/departement/upaTech/filiere/genie_civil/genie_civil.php");
    });
  // C:\wamp64\www\UPA\departement\upaTech\filiere\genie_civil
</script>  -->
...
<body>
	<!---------------------HEADER-------------------licence1GC----------------------HEADER-----------------------------------------------------HEADER------------------------------------->
<!-- echo '<html>'; UTILISATION SYMPHONY-->
  <header id="header" class="header">
   ...
   <li class="active"><a href="#home">Se connecter</a>
	...
	<?php 
		$classe="licence 1 génie Informatique";
		echo $classe;
	?>
	<p>licence 1 génie Informatique</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence1GI.php">	
...
<?php
	 ...
	 if(!empty($_GET['selectX']))
	 {
		...
		$conn=new PDO("mysql:host=127.0.0.1;dbname=upa","root");
		$sql = "INSERT INTO responsable_pedagogique (nom, prenom, classe, email) VALUES (?,?,?,?)";
