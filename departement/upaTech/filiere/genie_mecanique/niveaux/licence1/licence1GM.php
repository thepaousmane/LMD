...
<head>
	<meta charset="utf-8">  
  <title>licence 1 génie Mécanique</title>
...
<!-- echo '<html>'; UTILISATION SYMPHONY-->
  <header id="header" class="header">
   ...
   <li class="active"><a href="#home">Se connecter</a>
	...
	<?php 
		$classe="licence 1 génie Mécanique";
		echo $classe;
	?>
  <p>licence 1 génie Mécanique</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence1GM.php">	
