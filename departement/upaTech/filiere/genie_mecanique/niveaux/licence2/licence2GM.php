...
<head>
	<meta charset="utf-8">  
  <title>licence 2 génie Mécanique</title>
...
<body>
	<!---------------------HEADER-------------------licence2GM----------------------HEADER-----------------------------------------------------HEADER------------------------------------->
<!-- echo '<html>'; UTILISATION SYMPHONY-->
  <header id="header" class="header">
   ...
   <li class="active"><a href="#home">Se connecter</a>
	...
	<?php 
		$classe="licence 2 génie Mécanique";
		echo $classe;
	?>
  <p>licence 2 génie Mécanique</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence2GM.php">	
