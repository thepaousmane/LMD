...
<head>
	<meta charset="utf-8">  
  <title>licence 3 génie Mécanique</title>
...
<!-- 	<script type="text/javascript">
  ...
  history.pushState(null, null, "<?php //echo $_SERVER["REQUEST_URI"]; ?>");
  window.addEventListener("popstate", function(event) {
  window.location.assign("http://localhost/UPA/departement/upaTech/filiere/genie_mecanique/mecanique.php");
  });
  // C:\wamp64\www\UPA\departement\upaTech\filiere\genie_mecanique
</script> 
...
<body>
	<!---------------------HEADER-------------------licence3GM----------------------HEADER-----------------------------------------------------HEADER------------------------------------->
<!-- echo '<html>'; UTILISATION SYMPHONY-->
  <header id="header" class="header">
   ...
   <li class="active"><a href="#home">Se connecter</a>
	...
	<?php 
		$classe="licence 3 génie Mécanique";
		echo $classe;
	?>
  <p>licence 3 génie Mécanique</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence3GM.php">	
