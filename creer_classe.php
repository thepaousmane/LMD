...
<?php
  if(!empty($_POST['modifier_semestre'])||(!empty($_POST['name_nbr_semestre'])))
  {
    ...
    echo "semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section;

    $conn=new PDO("mysql:host=127.0.0.1;dbname=upa;charset=utf8","root");
    $sql=$conn->prepare("DROP TABLE IF EXISTS semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."");
    $sql->execute();


    $conn2=new PDO("mysql:host=127.0.0.1;dbname=upa;charset=utf8","root");
    $sql2=$conn2->prepare("DROP TABLE IF EXISTS UE_semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."");
    $sql2->execute();
...
&&(isset($_POST['Nb_Heures_total_'.$y.'_'.$i])))
    ...
    if((!empty($_SESSION['name_ue'.$i]))&&(isset($_POST['total_cdt_ue_'.$i])) )
    {
...
?>
<form action="afficher_classe.php" method="post">
    <table border="1">
      <tr>
          <th>Matieres</th>
          <th>Nb Heures CM</th>
...
$sql3="create TABLE IF NOT EXISTS ue_semestre_".$semestre_number."_annnee_".$classe_number."_".$nom_specialite."_".$name_section."(
  ...
  ?>
<form action="afficher_classe.php" method="get">
    <table border="1">
      <tr>
          <th>Matieres</th>
          <th>Nb Heures CM</th>
