...
<?php
  if(!empty($_POST['modifier_semestre']))
  {
    ...
    $sql2=$conn2->prepare("DROP TABLE IF EXISTS UE_semestre_".$semestre_number."_".$nom_specialite."_".$name_section."");
    $sql2->execute();
...
$sql3="create TABLE IF NOT EXISTS ue_semestre_".$semestre_number."_".$nom_specialite."_".$name_section."(
  id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  Unite_Enseignement varchar(100) NULL,
  semestre int(100) default 0,
  ...
  $conn3->exec($sql3);
   ...
   $sql4=$conn4->prepare("SELECT * from ue_semestre_".$semestre_number."_".$nom_specialite."_".$name_section."
      ");
    $sql4->execute();
    $data4=$sql4->fetchAll();
    $nbr = $sql4->rowCount();
      ...
      for($i=1;$i<=$_SESSION['nbr_ue'];$i++)
      {
        if(!empty($_SESSION['name_ue'.$i]))
        {
          ...
          // {
            ...
            $sql = "INSERT INTO UE_semestre_".$semestre_number."_".$nom_specialite."_".$name_section." 
...
<form action="classe.php" method="post">
   ...
   <?php
        $conn3=new PDO("mysql:host=127.0.0.1;dbname=upa;charset=utf8","root");
        $sql3=$conn3->prepare("SELECT * from ue_semestre_".$semestre_number."_".$nom_specialite."_".$name_section."
          ");
        $sql3->execute();
