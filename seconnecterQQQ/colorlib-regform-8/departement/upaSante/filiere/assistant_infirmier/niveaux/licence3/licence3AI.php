...
<head>
	<meta charset="utf-8">
	<title>licence 3 Assistant Infirmier</title>
</head>
...
<body>
	...
	<?php 
		$classe="licence 3 Assistant Infirmier";
		echo $classe;
	?>
	<p>licence 3 Assistant Infirmie</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence3AI.php">	
