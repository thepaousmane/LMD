...
<head>
	...
	<script type="text/javascript">
		...
		window.location.assign("http://localhost/UPA/seconnecter/colorlib-regform-8/departement/upaSante/filiere/sage_femme/sage_femme.php");
		});
		// \UPA\seconnecter\colorlib-regform-8\departement\upaSante\filiere\sage_femme
	</script>
</head>
<body>
	<a href="..\..\sage_femme.php"> <input type="submit" name="retour" value=retour></a>
	<?php 
