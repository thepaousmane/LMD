...
<head>
	<meta charset="utf-8">
	<title>licence 2 Biologie</title>
</head>
<script type="text/javascript">
	history.pushState(null, null, "<?php //echo $_SERVER["REQUEST_URI"]; ?>");
	window.addEventListener("popstate", function(event) {
	window.location.assign("http://localhost/UPA/seconnecter/colorlib-regform-8/departement/upaSante/filiere/biologie/biologie.php");
	});
	// C:\wamp64\www\UPA\seconnecter\colorlib-regform-8\departement\upaSante\filiere\biologie
</script> 
<body>
	<!-- <a href="..\..\infirmier.php"> <input type="submit" name="retour" value=retour></a> -->
	<?php 
		$classe="licence 2 Biologie";
		echo $classe;
	?>
	<p>licence 2 Biologie</p>
<?php
	 if(empty($_GET['envoyerX'])) 
	{
	 	?>
	
	<form method="get" action="licence2BIO.php">	
