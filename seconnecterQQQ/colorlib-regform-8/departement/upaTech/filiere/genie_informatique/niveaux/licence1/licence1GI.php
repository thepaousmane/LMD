...
<head>
	<meta charset="utf-8">
	<title>licence 1 Génie Informatique</title>
</head>
<script type="text/javascript">
	history.pushState(null, null, "<?php //echo $_SERVER["REQUEST_URI"]; ?>");
	window.addEventListener("popstate", function(event) {
	window.location.assign("http://localhost/UPA/seconnecter/colorlib-regform-8/departement/upaTech/filiere/genie_informatique/informatique.php");
	});
	// C:\wamp64\www\UPA\seconnecter\colorlib-regform-8\departement\upaTech\filiere\genie_informatique
</script> 
<body>
	<!-- <a href="..\..\infirmier.php"> <input type="submit" name="retour" value=retour></a> -->
	<?php 
		$classe="licence 1 Genie Informatique";
		echo $classe;
	?>
