...
<head>
	<meta charset="utf-8">
	<title>licence 3 Génie civil</title>
</head>
<script type="text/javascript">
		history.pushState(null, null, "<?php //echo $_SERVER["REQUEST_URI"]; ?>");
		window.addEventListener("popstate", function(event) {
		window.location.assign("http://localhost/UPA/seconnecter/colorlib-regform-8/departement/upaTech/filiere/genie_civil/genie_civil.php");
		});
	// C:\wamp64\www\UPA\seconnecter\colorlib-regform-8\departement\upaTech\filiere\genie_civil
</script> 
<body>
	<!-- <a href="..\..\infirmier.php"> <input type="submit" name="retour" value=retour></a> -->
	<?php 
		$classe="licence 3 Genie civil";
		echo $classe;
	?>
